package com.app.myarticleapp.utils
...
fun Context.alertInternet(context: Context) {
    ...
    dialog.findViewById<AppCompatTextView>(R.id.tvMsg).text = StringBuilder().append("please check internet")

    val tvCancel = dialog.findViewById<AppCompatTextView>(R.id.tvCancel)

    tvCancel.text = StringBuilder().append("Cancel")
    ...
    tvConfirm.text = StringBuilder().append("Open Settings")
